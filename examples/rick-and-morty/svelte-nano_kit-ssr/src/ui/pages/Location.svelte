<script module lang="ts">
  ...
  import { Residents$ as ResidentsStore$ } from '../../stores/characters.js'
  import { Location$ as LocationStore$ } from '../../stores/locations.js'

  export function Head$() {
    const { $location: location } = inject(LocationStore$)
  ...
  export function Stores$() {
    const { $location: location } = inject(LocationStore$)
    const { $residents: residents } = inject(ResidentsStore$)
