 ...
 * an effect or a scope stopped; a mountable node was mounted or unmounted; the lifecycle listeners
 * of a node are about to be called, or have been.
 */
export interface NodeInspectEvent {
  kind: typeof RunEvent
    | typeof RunEndEvent
    | typeof StopEvent
