...
export const PreactInjectorContext = /* @__PURE__ */ createContext<Injector | undefined>(undefined)
...
export function useInjector() {
  return useContext(PreactInjectorContext)
}
...
export function InjectorProvider({
  ...
  return (
    <PreactInjectorContext.Provider value={value}>
      {children}
    </PreactInjectorContext.Provider>
  )
}
...
export function Isolate({ children }: IsolateProps) {
  return (
    <PreactInjectorContext.Provider value={undefined}>
      {children}
    </PreactInjectorContext.Provider>
  )
}
