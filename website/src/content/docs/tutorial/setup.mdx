---
title: Setup
description: Start the Nano Kit tutorial and create the demo project shape.
sidebar:
  order: 1
---
...
Start with a Vite React app and install the Nano Kit packages used throughout the tutorial:
