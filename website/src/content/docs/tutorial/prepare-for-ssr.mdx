...
Router-derived state moves into a factory too. The router integration provides [`Location$`](/router/ssr#setting-up-ssr), and the factory derives params from it:
