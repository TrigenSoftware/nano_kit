...
For shared router APIs such as [`useLocation`](/router-integrations/react#uselocation), [`useNavigation`](/router-integrations/react#usenavigation), [`usePaths`](/router-integrations/react#usepaths), [`useListenLinks`](/router-integrations/react#usenavigationlistenlinks-uselistenlinks), see the [React Router integration](/router-integrations/react).
