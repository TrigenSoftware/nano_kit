...
<Aside>
  Most apps do not need to call `dehydrate` or wire `Hydrator$` manually. [Framework integrations](/getting-started) use these mechanisms under the hood. This manual flow is useful when you are building a custom SSR setup or want to understand how hydration works internally.
</Aside>
