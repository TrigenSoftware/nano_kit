...
- [Svelte Router](/integrations/svelte-router) — [`App`](/integrations/svelte-router#app), [`browserNavigation`](/integrations/svelte-router#setup), [`router`](/integrations/svelte-router#router), and other Svelte router APIs
