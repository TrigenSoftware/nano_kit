...
1. **Set up the root layout**
   ...
   Create a request-scoped dehydration injector in the root server layout and pass its reference to the root layout component.
...
3. **Hydrate page stores**
   ...
   Pass the dehydrated page data to `setHydrationInjector` in the page component.
