...
<Aside>
  If you are looking to add SSR to app code, use the matching [framework integration](/getting-started) instead. This page is for authors building new framework adapters.
</Aside>
...
- [`@nano_kit/react-ssr`](/ssr-integrations/react) — The React adapter built with this package.
- [`@nano_kit/preact-ssr`](/ssr-integrations/preact) — The Preact adapter built with this package.
