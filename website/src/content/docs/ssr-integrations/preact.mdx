...
- [Preact Router](/router-integrations/preact) — [`App`](/router-integrations/preact#app), [`browserNavigation`](/router-integrations/preact#setup), [`router`](/router-integrations/preact#router), and other Preact router APIs
